...
export function Hero() {
  return (
    <div className="relative h-screen w-full bg-[#050505] flex flex-col overflow-hidden selection:bg-indigo-500/30">
      
      {/* Subtle Grain/Noise Texture if desired, but sticking to pure minimalist vector for now */}
      
      {/* Navigation */}
      <nav className="relative z-10 w-full h-32 flex items-center justify-between px-12 border-b border-white/5">
      ...
      <div className="flex-1 relative z-10 grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="relative flex flex-col justify-end pb-32 pl-12 pr-12 border-r border-white/5">
           <motion.div 
             ...
             className="max-w-xl"
           >
             <div className="flex flex-col gap-1 mb-12 opacity-50">
                <span className="text-[10px] text-indigo-400 font-mono tracking-widest uppercase">Fig. 01 — Consilience</span>
             </div>

             <h1 className="text-6xl md:text-8xl font-light tracking-tighter text-white mb-12 leading-[0.95]">
               Thought <br />
               <span className="text-zinc-600">Architecture.</span>
             </h1>
             
             <p className="text-zinc-400 text-sm leading-relaxed font-light max-w-sm mb-12 tracking-wide">
        ...
        <div className="relative flex items-center justify-center overflow-hidden">
           ...
           {/* The Artifact */}
           <div className="relative w-[600px] h-[600px] flex items-center justify-center opacity-80">
              ...
              <motion.div 
                ...
                className="absolute w-[350px] h-[350px] rounded-full border border-dashed border-indigo-500/20"
              />
              ...
              {[1, 2, 3].map((i) => (
                  <motion.div
                    ...
                    className={cn(
                        ...
                        i === 1 ? "w-[200px] h-[200px]" : 
                        i === 2 ? "w-[280px] h-[280px] border-indigo-500/10" : 
                        "w-[420px] h-[420px]"
                    )}
                  />
              ))}
           ...
           <div className="absolute bottom-12 right-12 flex flex-col items-end gap-1 text-[8px] font-mono text-zinc-700">
              <span>R_42.091</span>
              <span>Θ_12.550</span>
