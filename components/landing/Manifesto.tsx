...
export function Manifesto() {
  return (
    <div className="py-40 bg-[#050505] border-t border-white/5 flex flex-col items-center text-center relative overflow-hidden">
      ...
      <div className="max-w-4xl px-12 relative z-10">
        <span className="text-[10px] text-zinc-600 font-mono tracking-[0.25em] uppercase mb-12 block">Fig. 04 — The Logic</span>
        
        <h2 className="text-4xl md:text-6xl font-light tracking-tighter text-white leading-[1.1] mb-16">
        ...
        >
           <p className="text-8xl md:text-9xl font-bold tracking-tighter text-white/5 select-none">
              COMMON
           </p>
        </motion.div>
      </div>
